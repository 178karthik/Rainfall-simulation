...
void display()
{
    ...
    Sprint(50,450,"Karthik R");
	Sprint(40,400,"Hemanth");
...
//CODE FOR FIRST YELLOW BOARD.
	...
	Sprint(43,530,"UDRS");// display project name.
...
//MESSAGE DISPLAY
	...
	Sprint(30,50,"PROJECT BY:");
    Sprint(30,30,"Karthik R");
	Sprint(30,10,"K Hemanth");
//CODE FOR Project
	glColor3f(0.0,0.9,0.0);
	glLineWidth(10.0);
	glBegin(GL_LINES);
...
void spindisplayy()
{
	...
	{
		glColor3f(0.0,0.0,0.0);
		Sprint(30,260,"pitched outside,NOT OUT");
	}
    glPushMatrix();
...
int main(int argc,char**argv)
{
	...
	glutCreateWindow("UDRS TECHNOLOGY");
